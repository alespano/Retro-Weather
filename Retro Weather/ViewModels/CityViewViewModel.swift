...
final class CityViewViewModel: ObservableObject {
    ...
    // Pixel art icons
    func getPixelIconFor(icon: String) -> Image {
        switch icon {
        case "01d":
            return Image("dayClearSky")
        case "01n":
            return Image("nightClearSky")
        case "02d":
            return Image("dayFewClouds")
        case "02n":
            return Image("nightFewClouds")
        case "03d":
            return Image("dayScatteredClouds")
        case "03n":
            return Image("nightScatteredClouds")
        case "04d":
            return Image("dayBrokenClouds")
        case "04n":
            return Image("nightBrokenClouds")
        case "09d":
            return Image("dayShowerRains")
        case "09n":
            return Image("nightShowerRains")
        case "10d":
            return Image("dayRain")
        case "10n":
            return Image("nightRain")
        case "11d":
            return Image("dayThunderstorm")
        case "11n":
            return Image("nightThunderstorm")
        case "13d":
            return Image("daySnow")
        case "13n":
            return Image("nightSnow")
        case "50d":
            return Image("dayMist")
        case "50n":
            return Image("dayMist")
        default:
            return Image("dayClearSky")
